...
Couchlike.prototype.isCouchbasey = function() {
	return (this.config && this.config.couchlike && (this.config.type === engineType.mock || this.config.type === engineType.couchbase || this.config.type === engineType.couchbaseSyncGateway));
};
